...
Menu() {
    ...
    21) App="com.datami.reach4all" ; atividade="com.datami.reachall.SplashScreen" ; A3="su -c am start -n com.datami.reachall/com.datami.reachall.my.activities.VideoActivity2" ; nome="ReachAll" ; A2="su -c am start -n com.datami.reachall/com.datami.smi.ui.VpnPermissionActivity" ; s="sleep 4" ; A4="su -c am start -n com.datami.reachall/com.datami.reachall.my.activities.SplashScreen" ; db="su -c pm disable com.datami.reachall" ; eb="su -c pm enable com.datami.reachall";;
    0) clear ; exit ;;
