...
Menu() {
    ...
    21) App="com.datami.reach4all" ; aatividade="com.datami.reachall.SplashScreen" ; A3="su -c am start -n com.datami.reachall/com.datami.reachall.VideoActivity2" ; nome="ReachAll" ; A2="su -c am start -n com.datami.reachall/com.datami.reachall.VpnPermissionActivity" ; s="sleep 4" ; A4="su -c am start -n com.datami.reach4all/com.datami.reachall.SplashScreen" ; db="su -c pm disable com.datami.reachall" ; eb="su -c pm enable com.datami.reach4all";;
    0) clear ; exit ;;
